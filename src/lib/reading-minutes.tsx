 ...
 * fenced code at 15 lines a minute, never less than one minute. Lines above a
 * twoslash `// ---cut---` are compiled but never shown, so they do not count.
 *
...
function cutLine(block: string) {
 return block.split("\n").findIndex((line) => line.trim() === "// ---cut---") + 1;
}
