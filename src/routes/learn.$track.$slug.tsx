...
function Chapter() {
  ...
  return (
    // The rail sits beside the prose rather than inside it, so the prose keeps
    // its max-w-3xl at every breakpoint. Below xl the rail is hidden and the
    // article is the only child, which centres exactly as it did before.
      ...
      <article className="w-full max-w-3xl px-6 py-10">
        ...
        {chapter.meta.draft ? (
          <p className="border-muted-foreground/30 bg-muted/40 text-muted-foreground mb-8 rounded-lg border border-dashed p-4 text-sm">
            This page is an outline. The headings say what it will cover, and
